...
# url shortner
SHORT_URL = environ.get("SHORT_URL", "https://shrinkme.io")
SHORT_API = environ.get("SHORT_API", "5122042c446fe918dfb63b258df366aa0ea0683f")
...
reqst_channel = environ.get('-1001980062268')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = -1001966865235
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", True))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "GMF")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'gmsupportgroup')
